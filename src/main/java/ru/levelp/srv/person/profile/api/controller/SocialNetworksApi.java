...
@Validated
@Api(value = "social-networks", description = "the social-networks API")
public interface SocialNetworksApi {

    /**
     * PUT /social-networks/{socialNetworkId}
     * Create a new social network record.
     *
     * @param socialNetworkId Universally unique identifier of the social network. (required)
     ...
     */
    @ApiOperation(value = "", nickname = "createSocialNetwork", notes = "Create a new social network record.", tags = {"social-networks",})
    @ApiResponses(value = {
     ...
     * Deletes an existing social network record.
     *
     * @param socialNetworkId Universally unique identifier of the social network. (required)
     ...
     * or A server side error occurred while processing the request. (status code 500)
     */
    @ApiOperation(value = "", nickname = "deleteSocialNetwork", notes = "Deletes an existing social network record.", tags = {"social-networks",})
    @ApiResponses(value = {
    ...
    ResponseEntity<Void> deleteSocialNetwork(@Size(max = 255) @ApiParam(value = "Universally unique identifier of the social network.", required = true) @PathVariable("socialNetworkId") String socialNetworkId);


    /**
     * GET /social-networks
     * Returns all social networks found according to search criteria.
     *
     ...
     * or A server side error occurred while processing the request. (status code 500)
     */
    @ApiOperation(value = "", nickname = "getSocialNetworks", notes = "Returns all social networks found according to search criteria.", response = SocialNetworkListResponse.class, tags = {"social-networks",})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "The request has been successfully processed. The body contains the result.", response = SocialNetworkListResponse.class),
            @ApiResponse(code = 400, message = "A malformed request was sent.", response = ProblemResponse.class),
            @ApiResponse(code = 401, message = "Authentication is required to access the resource.", response = ProblemResponse.class),
            @ApiResponse(code = 403, message = "There are no permissions to access the resource.", response = ProblemResponse.class),
            @ApiResponse(code = 500, message = "A server side error occurred while processing the request.", response = ProblemResponse.class)})
